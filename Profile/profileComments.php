...
<html lang="en">
    ...
    <?php 
            if (isset($_GET['created'])) {
                ...
                <div>Answer ".$_GET['created']."<span class='highlightWord'> successfully!</span></div>
            ...
            if (isset($_GET['deleted'])) {
                ...
                <div class='modal block'>
                    ...
                    <form action='process-deleteAnswer.php' class='modal-footer'>
        ...
        <section>
         <div style="width: 300px; height:100%;"></div>
            <div class="menu block">
                ...
                >
                <a href="#"
                    ><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#6C63FF" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M7.5 8.25h9m-9 3H12m-9.75 1.51c0 1.6 1.123 2.994 2.707 3.227 1.129.166 2.27.293 3.423.379.35.026.67.21.865.501L12 21l2.755-4.133a1.14 1.14 0 0 1 .865-.501 48.172 48.172 0 0 0 3.423-.379c1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0 0 12 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018Z" />
                    </svg>

                    <span class='highlightWord'>Your Comments</span></a
                >
            ...
            <div class="content">
                <form action="profileComments.php" method="get">
                    <input
                        type="text"
                        name="search"
                        id="search"
                ...
                <div class="grid-container-questions">
                    <!-- <p class='from-question'>for Q: <span class='highlightWord'>".$row['title']."</span></p> -->
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <div class='top-info'>
                        <p class='from-question'>For Q: <span class='highlightWord'>".$row['title']."</span></p>
                        <p class='askedBy-user'>Asked by: <span class='highlightWord'>".$row['quser_name']."</span></p>
                        </div>
                        <a href='../Question/questionCommentView.php?id=".$questionId."' class='question-title'>".$row['textField']."</a>
                        <div class='img-holder'>
                        <a href='../Question/questionCommentView.php?id=$questionId&editedId=".$row['id']."'><img src='../assets/edit.svg' alt='' /></a>
                        <a href='../Question/questionCommentView.php?deleted=Comment&id=$questionId&deleteId=".$row['id']."'><img src='../assets/delete.svg' alt='' /></a>
                        </div>
                        <p class='question-time'>".getDateDiff($row['cDate'])."</p>
                        </div>";
                        } else {
                            $answerId = $row['aid'];
                            echo "<div class='question block'>
                            <div class='top-info'>
                        <p class='from-question'>For A: <span class='highlightWord'>".$row['answerText']."</span></p>
                        <p class='askedBy-user'>Written by: <span class='highlightWord'>".$row['auser_name']."</span></p>
                        </div>
                        <a href='../Question/answerCommentView.php?id=".$answerId."' class='question-title'>".$row['textField']."</a>
                        <div class='img-holder'>
                        <a href='../Question/answerCommentView.php?id=$answerId&editedId=".$row['id']."'><img src='../assets/edit.svg' alt='' /></a>
                        <a href='../Question/answerCommentView.php?deleted=Comment&id=$answerId&deleteId=".$row['id']."'><img src='../assets/delete.svg' alt='' /></a>
                        </div>
                        <p class='question-time'>".getDateDiff($row['cDate'])."</p>
                    </div>";
