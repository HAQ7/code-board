         ...
         <div style="width: 300px; height:100%;"></div>
            <div class="menu block">
                ...
                <a href="#"
                    ...
                    <span class="highlightWord"> Your answers</span></a
                >
            ...
            <div class="content">
                <form action="profileAnswers.php" method="get">
                    <input
                        type="text"
                        name="search"
                        id="search"
                ...
                <div class="grid-container-questions">
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <p class='askedBy-user'>Asked by: <span class='highlightWord'>".$row['username']."</span></p>
                        </div>
                        <a href='../Question/answerCommentView.php?id=".$row['id']."' class='question-title'>".$row['answerText']."</a>
                        <div class='img-holder'>
                            <a href='../Question/questionView.php?id=".$row['questionId']."&editedId=".$row['id']."'><img src='../assets/edit.svg' alt='' /></a>
                            <a href='profileAnswers.php?deleted=true&id=".$row['id']."'><img src='../assets/delete.svg' alt='' /></a>
                        </div>
                        <p class='question-time'>".getDateDiff($row['aDate'])."</p>
