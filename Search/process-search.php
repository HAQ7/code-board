...
if (isset($_GET['search'])) {
    $search = $_GET['search'];
    $records = mysqli_query($conn, "SELECT * FROM question WHERE title LIKE '%$search%'");
} else {
$records = mysqli_query($conn, "SELECT * FROM question ");
}
...
if (isset($_GET['search'])) {
    $search = $_GET['search'];
    $result = mysqli_query($conn, "SELECT * FROM question WHERE title LIKE '%$search%' ORDER BY qDate desc LIMIT $start, $limit");
} else {
    $result = mysqli_query($conn, "SELECT * FROM question ORDER BY qDate desc LIMIT $start, $limit");
}
